...
Points
#We want a function that gives you subset data based on player name and year

Points["KobeBryant","2005",drop=F]

playersalary <- function(player, year){
  Points[player,year,drop=F]
}

playersalary("KobeBryant", "2008")
